...
export function Hero() {
  ...
  // Move the image down slightly as the user scrolls down
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24 relative z-10">
      <div className="flex flex-col items-center text-center mb-16 relative">
        ...
        <div className="flex flex-col sm:flex-row items-center w-full max-w-2xl bg-white p-2 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-black/5 relative z-20 transition-shadow hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          ...
          {/* Enhanced CTA Button */}
          <button className="w-full sm:w-auto bg-brand-orange hover:bg-brand-orange-hover text-white px-10 py-4 rounded-full text-base font-bold transition-all duration-300 cursor-pointer flex items-center justify-center gap-2 group hover:scale-105 hover:shadow-[0_8px_20px_rgba(242,117,78,0.4)] active:scale-95">
            Search <ArrowRight size={18} className="group-hover:translate-x-1.5 transition-transform" />
          </button>
        </div>
      </div>
      ...
      <div ref={ref} className="relative w-full h-[400px] md:h-[600px] rounded-[2.5rem] overflow-hidden group">
        ...
        <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end pointer-events-none">
          <div className="flex items-center gap-4 bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 text-white pointer-events-auto">
          ...
          <div className="hidden md:block text-white text-right pointer-events-auto">
